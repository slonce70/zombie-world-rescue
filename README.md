...
**v502** — завершене оновлення «Живого фронту»:
...
У v502 етапи стали короткими й цілеспрямованими, спеціалісти та Радіовежа отримали реальні бонуси, глобус показує стан фронту, а co-op коректно завершує спеціальні етапи для всієї команди.
