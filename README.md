...
**v501** — стабілізаційне оновлення «Живого фронту»:
...
У v501 виправлено opt-in і повторну відправку метрик, оновлено regression-тести та посилено CI-перевірку кампанії.
