...
**v512** — мури польського замку лишаються суцільними на всіх розмірах карти; додано прохідне 50-метрове підземелля з 5 зомбі-чаклунами.
...
Версія релізу синхронізується у `version.json`, `APP_VERSION` та service-worker cache. Front wire format використовує `PROTO_VERSION = 18`.
