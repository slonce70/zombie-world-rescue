...
Релізні ранери автоматично знаходять `test/*.mjs`. PR/push блокують focused smoke та Expedition gates; повна батарея і real-combat e2e йдуть щоночі та вручну. Для локального відтворення повного soak shard:
