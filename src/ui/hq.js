...
const BESTIARY = [
  ...
  { id: 'wizard', icon: '🧙', name: t('Чаклун'), desc: t('Кайтить, ставить собі щит і шпурляє магію — добивай швидко!') },
  ...
  { id: 'gladiator', icon: '🛡️', name: t('Гладіатор'), desc: t('Бронзовий шолом, меч і щит — розганяється у випад!') },
  { id: 'samurai', icon: '🗡️', name: t('Самурай'), desc: t('Катана, темна броня і швидкий ривок.') },
  { id: 'terracotta', icon: '🏺', name: t('Теракотовий воїн'), desc: t('Глиняна броня і спис — розганяється у важкий випад!') },
  { id: 'shaman', icon: '🪬', name: t('Зомбі-шаман'), desc: t('Воскресає один раз — добий двічі! Може лишити тотем безсмертя.') },
  { id: 'robot', icon: '🤖', name: t('Зомбі-робот'), desc: t('Бойовий мех із пілотом-зомбі: меч зблизька, гармата здаля. Коли падає — ВИБУХАЄ! Відскоч.') },
  { id: 'toro', icon: '🐂', name: t('Торо'), desc: t('Зомбі-бик — розганяється і б’є рогами!') },
  { id: 'imp', icon: '🧟', name: t('Шкет'), desc: t('Дрібний і дуже швидкий — наздожене будь-кого!') },
  { id: 'ghost', icon: '👻', name: t('Привид'), desc: t('Невидимий! Увімкни гаджет Ікс-рей, щоб його побачити.') },
  { id: 'golden', icon: '🌟', name: t('Золотий зомбі'), desc: t('Тікає від тебе — дожени і отримай джекпот!') },
  { id: 'boss', icon: '👑', name: t('Бос'), desc: t('Велетенський ватажок орди. Переможи — і врятуй країну!') },
];
