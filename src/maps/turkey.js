...
export default {
  ...
  // Босфор: широке русло вздовж західного берега. Корабельна місія йде
  // паралельно берегу всередині цієї води, а не поверх звичайного рельєфу.
  rivers: [{ pts: [[-165, 108], [-165, 40], [-165, -24], [-165, -100]], width: 17, level: -2.5, depth: 1.2 }],
  sites: {
  ...
  storySites: {
    ...
    shipDock: { x: -156, z: 78, r: 7 },
    rescueShore: { x: -156, z: -70, r: 7 },
