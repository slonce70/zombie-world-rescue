...
export default {
  ...
  // 📖 «Килими й Босфор»: точки історії (поруч із моделями, не всередині)
  storySites: {
    grandBazaar: { x: -56, z: 4, r: 10 },      // північний вхід базару (всередині — пілони й прилавки)
    bosphorusTower: { x: 118, z: -86, r: 7 },  // біля вежі Галата (модель r3.6 на 112,-92, батут на 108,-86 — точка зі сходу)
    spiceDepot: { x: -108, z: 50, r: 8 },      // перед складом (бочки на -102,58 і -116,70 — точка південніше)
    teaGarden: { x: 38, z: 38, r: 7 },         // край чайного садка (столики в центрі мають колайдери)
    boardsCrate: { x: 72, z: 126, r: 5 },
    shipDock: { x: -165, z: 78, r: 7 },
    rescueShore: { x: -165, z: -70, r: 7 },
    arena: { x: 24, z: -158, r: 28 },
  },
  roads: [
