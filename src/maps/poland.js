...
export default {
  ...
  storySites: {
    ...
    // 📖 «Північне сяйво» (SWE ділить цю карту): нордичні ключі НЕ конфліктують з польськими
    longhouse: { x: -26, z: -12, r: 10 },   // довгий дім вікінгів = кам'яниця порятунку
    auroraTower: { x: 140, z: -56, r: 10 }, // вежа сяйва = пагорб вежі (модель на 140,-62)
    jarlCamp: { x: -100, z: 48, r: 10 },    // табір Ярла перед депо (бочка на -104,56 і вагони z≈71 — точка південно-східніше)
  },
  roads: [
