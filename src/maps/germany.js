...
export default {
  ...
  // 📖 «Осінній конвой»: точки історії на чистій геометрії (поруч із моделями, не в них)
  storySites: {
    workshop: { x: -95, z: -60, r: 8 },     // майстерня механіків = сайт порятунку
    autobahn: { x: 20, z: 102, r: 14 },     // узбіччя автобана (машини генеруються в смузі z 106..114 — точка південніше)
    cityGate: { x: 0, z: 54, r: 10 },       // перед брамою (модель на 0,64 — точка південніше, на дорозі)
    barracks: { x: -78, z: -112, r: 16 },   // казарма осторонь дороги до арени й майстерні
    arena: { x: -25, z: -160, r: 28 },
  },
  roads: [
  ...
  flats: [
    ...
    { x: -78, z: -112, r: 20 }, // чистий майданчик під казарму зомбі
  ],
  houses: [
