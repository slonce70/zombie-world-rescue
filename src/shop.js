...
export const SHOP_ITEMS = [
  ...
  { id: 'meteor-hyper', icon: '⚡', name: t('Гіперзаряд: Метеорит'), desc: t('Після падіння лишає вогонь: 5 HP/с'), price: 5000, max: 1, cat: t('Гаджети й друзі'), hyper: 'meteor', needsGadget: 'meteor' },
