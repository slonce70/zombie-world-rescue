...
console.log('▸ F24: saveHasProgress бачить новий прогрес');
{
  ...
  const res = await U.evaluate(async () => {
    ...
    const guardedTopLevelKeys = new Set([
      ...
      'gadgetHypers', 'goal', 'hero', 'hints', 'infected', 'kidMode', 'strongZombies', 'toughZombies', 'mapSize', 'liberated', 'medals',
      ...
      // 🌍 v303 «Світ врятовано»
      'worldSaved',
      'expedition', 'front', 'frontCoopClaims',
    ]);
    ...
    out.progressManifestHasCurrentCategories = [
      ...
      'eggs', 'eggClaims', 'friendEggClaims', 'petFood', 'petLevels',
      'weeklyCamp', 'worldSaved', 'expedition', 'front', 'frontCoopClaims',
