...
// Картки про рух і виживання (стрибок, слід, перезарядка, порятунок, магніт) — так само.
const combatSnapshot = (p) => [
  ...
  p.airJumps || 0, p.fireTrail || 0, p.killReload || 0, p.secondWind || 0,
  p.coinMagnet || 0, p.pickupMult || 1,
];
