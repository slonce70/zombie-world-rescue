...
check(Object.entries(gad.prices).every(([id, p]) => ['healtotem', 'damagetotem'].includes(id) ? p === 0 : p === 1000),
  'монетні гаджети коштують 1000, тотеми купуються за кристали', JSON.stringify(gad.prices));
