...
try {
  ...
  await ping('cid-profile-1', 'Аня', { countries: 2, coins: 75, crystals: 4, kills: 9, star: 3, title: 'Зомбі кілер' });
  const v = await ping('cid-profile-2', 'Боря', { countries: 99, coins: -5, crystals: 2.7, kills: 4, star: 8, title: '<b>0 монет</b>' });
  ...
  check(!!anya && anya.countries === 2 && anya.coins === 75 && anya.crystals === 4 && anya.kills === 9 && anya.star === 3 && anya.title === 'Зомбі кілер',
    'профіль віддає статистику гравця', JSON.stringify(anya));
  check(!!borya && borya.countries === 99 && borya.coins === 0 && borya.crystals === 2 && borya.kills === 4 && borya.star === 5 && borya.title === '0 монет',
